...
if ( !function_exists( 'st_get_preset_theme_mod_overrides' ) ) {
	/**
	 * オリジナルカスタマイザー **使用時** の theme_mod の値を取得
	 *
	 * プリセットを使用 **する** 場合の値を取得
	 *
	 * `st_get_plain_theme_mod_defaults()` の値から **上書きする値のみ** を取得
	 *
	...
	function st_get_preset_theme_mod_overrides( $preset_name ) {
		...
		return array(
			...
			'st_headbox_bgcolor'     => $basecolor,    //ヘッダーの背景色下部
			...
			'st_footer_bg_color_t'    => $basecolor,       //フッター背景色上部
			...
			'st_h4_matome_bgcolor'       => $basecolor,        //h4（まとめ）の背景色
			...
			'st_catbg_color'   => $basecolor, //カテゴリーの背景色
			...
			'st_menu_navbarcolor_t'         => $basecolor, //メニューの背景色上
			...
			'st_menu_side_widgetscolor_t'         => $basecolor,        //サイドメニューウィジェットの背景色上
			...
			'st_widgets_titleborder_undercolor'  => $basecolor, //ウィジェットタイトルのボーダー色（2色アンダーライン）
			...
			'st_menu_sumartbar_bg_color'  => $basecolor,       //スマホメニューバーエリア内背景色
			...
			//ガイドメニュー
			'st_guidemenu_bg_color'     => $basecolor, //背景色（第一階層）
			...
			'st_middle_sumart_bg_color_t'     => $basecolor, //背景色（グラデーション上部※向きはヘッダーナビゲーション連動）
			...
			'st_toc_bgcolor'             => '', //背景色
			'st_toc_list_icon_base'      => '#cccccc', //リスト数字・アイコン
			...
			//チェックボックスのカラー
			'st_webicon_checkbox'          => $basecolor, //チェック色
			'st_webicon_checkbox_square'   => $subcolor, //チェックの枠色

			//タイムラインのカラー
			'st_timeline_list_color'         => $basecolor, //ラインカラー
			...
			'st_table_tr_bgcolor'   => $basecolor, //横一列目の背景色
			...
			'st_step_color'               => $basecolor, //ステップ数の色
			...
			//オリジナルブロック
			'st_memo_block_icon_color'      => $maincolor, //メモブロックの文字色
			'st_memo_block_bg_color'        => $subcolor, //メモブロックの背景色
			'st_memo_block_border_color'    => $subcolor, //メモブロックの枠線
			'st_mybox_block_icon_color'      => $maincolor, //マイボックスブロックの文字色
			'st_mybox_block_bg_color'        => $subcolor, //マイボックスブロックの背景色
			'st_mybox_block_border_color'    => $maincolor, //マイボックスブロックの枠線
			'st_freebox_block_icon_color'    => $textcolor, //見出し付きフリーボックスブロックの文字色
			'st_freebox_block_bg_color'      => $subcolor, //見出し付きフリーボックブロックの背景色
			'st_freebox_block_border_color'  => $maincolor, //見出し付きフリーボックブロックの枠線
			'st_banarbox_block_icon_color'    => $maincolor, //バナー風ボックスブロックの文字色
