			...
			<article>
				<div class="post post-search">
					...
					<?php if ( is_active_sidebar( 32 ) ) { ?>
						<?php if ( function_exists( 'dynamic_sidebar' ) && dynamic_sidebar( 32 ) ) : else : //検索結果ページ（上部）ウィジェット ?>
						<?php endif; ?>
					<?php } ?>
					...
					<?php if ( is_active_sidebar( 33 ) ) { ?>
						<?php if ( function_exists( 'dynamic_sidebar' ) && dynamic_sidebar( 33 ) ) : else : //検索結果ページ（下部）ウィジェット ?>
						<?php endif; ?>
					<?php } ?>
