...
<html amp <?php language_attributes(); ?>>
	<head>
		...
		<?php if ( isset( $GLOBALS["stdata400"] ) && $GLOBALS["stdata400"] === 'yes' ): // fontawesome4.7.0読み込み ?>
								...
								<main>
									<article>
										<div id="post-<?php the_ID(); ?> st-post" <?php post_class(); ?>>
											...
											<h1 class="entry-title"><?php if ( st_is_ver_ex() ): st_the_title(); else: the_title(); endif;    // タイトル ?></h1>
										...
										<?php if ( is_active_sidebar( 19 ) ): ?>
											<div class="side-topad">
												<?php if ( function_exists( 'dynamic_sidebar' ) ): ?>
													<?php dynamic_sidebar( 19 );    // AMP用サイドバー（中部） ?>
												<?php endif; ?>
											</div>
										<?php endif; ?>
									</div>
