...
<!DOCTYPE html>
	...
	<body id="st-redirect" ontouchstart="" <?php body_class(); ?>>
					...
					<main>
						<div class="post" onSelectStart="return false;" onMouseDown="return false;" style="-moz-user-select: none; -khtml-user-select: none; user-select: none;">
							<article>
								...
								<div>
									<p>安全にリダイレクト中です。<br/>しばらくお待ち下さい。<br/>うまくサイトに切り替わらない場合は<br/><a href="<?php echo esc_url( $redirect_url ); ?>">こちら</a>をクリックして下さい。</p>
									<!--ループ開始 -->
