<?php
/**
 * @var WP_Post $_post 投稿の WP_Post オブジェクト。
 * @var WP_QUery $query 関連生地の WP_Query オブジェクト。
 * @var string[] $classes クラス
 */
...
<div class="<?php echo esc_attr( $class ); ?>" data-st-load-more-content
	...
	<?php if ( $query->have_posts() ): $offset = _st_query_calculate_offset( $query ); // 必須 ?>
